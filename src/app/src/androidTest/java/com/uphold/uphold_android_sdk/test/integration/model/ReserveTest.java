...
public class ReserveTest {
    ...
    public void getLedgerShouldReturnThePaginatorCount() throws Exception {
        ...
        adapter.request(new RepromiseFunction<UpholdRestAdapter, Integer>() {
            ...
            public Promise<Integer> call(UpholdRestAdapter adapter) {
                ...
                reserve.setUpholdRestAdapter(adapter);
    ...
    public void getLedgerShouldReturnTheListWithDeposits() throws Exception {
        ...
        adapter.request(new RepromiseFunction<UpholdRestAdapter, List<Deposit>>() {
            @Override
            public Promise<List<Deposit>> call(UpholdRestAdapter adapter) {
                Reserve reserve = new Reserve();
    ...
    public void getStatisticsShouldReturnTheListWithReserveStatistics() throws Exception {
        ...
        adapter.request(new RepromiseFunction<UpholdRestAdapter, List<ReserveStatistics>>() {
            @Override
            public Promise<List<ReserveStatistics>> call(UpholdRestAdapter adapter) {
                Reserve reserve = new Reserve();
