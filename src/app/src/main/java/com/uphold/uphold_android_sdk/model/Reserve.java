...
public class Reserve extends BaseModel implements Serializable {
    ...
    public Paginator<Deposit> getLedger() {
        ...
        ReserveService reserveService = this.getUpholdRestAdapter().create(ReserveService.class);
        ...
        final PaginatorInterface<Deposit> paginatorInterface = new PaginatorInterface<Deposit>() {
            ...
            public Promise<List<Deposit>> getNext(String range) {
                RetrofitPromise<List<Deposit>> promise = new RetrofitPromise<>();
                ReserveService reserveService = Reserve.this.getUpholdRestAdapter().create(ReserveService.class);
